For more precise follow me linkedin you can have the better view
...
To be deleted-(Very Important)
Eks cluster (1st node group from compute tab)
Roles
Check for elb and autoscaling group,
Terminate instance 
Vpc 
Volumes
Double check ec2 dashboard
